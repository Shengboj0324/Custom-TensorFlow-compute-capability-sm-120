...
class TensorFlowValidator:
    ...
    def print_recommendations(self) -> None:
        ...
        if not failed_results:
            log_success("All checks passed! Your TensorFlow sm_120 installation is working correctly.")
        ...
        for result in failed_results:
            ...
            if "TensorFlow Import" in result.name:
                ...
                print("  Solution: Ensure you're using the custom-built TensorFlow with CUDA support")
                ...
                print("    The custom build will still work on other GPUs with reduced optimization")
